...
// Tours
export const User_Tour = "/users/user_tours"

// LLMs
export const LLMModels = "/llms/llm_models"
//Users
export const POST_REGISTER = "/users/register"; 
export const USER_ACTIVATION = "/users/activate_user"
export const RESEND_USER_ACTIVATION = "/users/resend_user_activation"
...
export const CHECK_LOGIN = "/users/check-login";
