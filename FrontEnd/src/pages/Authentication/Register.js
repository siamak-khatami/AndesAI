...
import { initializeTagManager } from "../../Layouts/Gtag";
const Register = () => {
    ...
    const validation = useFormik({
        ...
        validationSchema: Yup.object().shape({
            ...
            family: Yup.string().required('Please enter your last name'),
            password: Yup.string()
    ...
    const { error, registrationError, success, registering } = useSelector(state => ({
    ...
    document.title = "Register | " + AppPublicName;
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium">Example</p>
                                </div>
                            </Col>
                        </Row>
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                {success && success ? (
                                                    <>
                                                        {toast("You Are Redirecting To Login Page...", { position: "top-right", hideProgressBar: false, className: 'bg-success text-white', progress: undefined, toastId: "" })}
                                                        <ToastContainer autoClose={7000} limit={1} />
                                                        <div className="alert alert-success alert-dismissible fade show" role="alert" id="RegisterSuccessAlert">
                                                            <strong> Yey! You are registered successfully! </strong> An activation email has been sent to your email address.
                                                ...
                                                <div className="mb-3">
                                                    <Label htmlFor="username" className="form-label">Family name<span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="family"
                                                        type="text"
                                                        placeholder="Enter username"
                                                    ...
                                                    {validation.touched.family && validation.errors.family ? (
                                                        <FormFeedback type="invalid"><div>{validation.errors.family}</div></FormFeedback>
                                                    ) : null}
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Example.Com Terms and Conditions
                                                        <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                </div> 
                                                <div className="mt-4">
                                                    <button className="btn btn-success w-100" type="submit">
                                                        Sign Up {registering?<Spinner size="sm"></Spinner>:null}
                                                    </button>
                                                </div>
