...
const ForgetPasswordPage = props => {
  ...
  const { Error, SuccessMsg, requestingReset } = useSelector(state => ({
    Error: state.ForgetPassword.Error,
    SuccessMsg: state.ForgetPassword.SuccessMsg,
    requestingReset: state.ForgetPassword.requestingReset,
  }));  
...
document.title= "Forgot Password | " + AppPublicName ;
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="text-center mt-4">
                        ...
                        {
                          requestingReset?<Spinner size="sm"></Spinner>:null
                        }
                        </button>
                      </div>
                    </Form>
